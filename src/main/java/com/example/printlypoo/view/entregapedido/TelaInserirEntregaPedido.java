...
public class TelaInserirEntregaPedido {

    public void exibir() {
        Stage stage = new Stage();
        stage.setTitle("Registrar Entrega");
        ...
        btnSalvar.setOnAction(e -> {
            try {
                ...
                new EntregaPedidoController().inserir(ep);
                lblMsg.setText("Entrega registrada com sucesso!");
        ...
        stage.setScene(new Scene(layout, 460, 320));
        stage.show();
    }
}
